...
exports.changeUsername = utils.toPromise(function (oldUsername, newUsername, opts, callback) {
  ...
  .then(function (user) {
    ...
    user._id = USERNAME_PREFIX + newUsername;
    ...
    var oldUserId = USERNAME_PREFIX + oldUsername;
    var url = utils.getUsersUrl(db) + '/' + encodeURIComponent(oldUserId);
    var deleteOpts = utils.extend(true, {
      method : 'DELETE',
      url : url
    }, opts.ajax);
